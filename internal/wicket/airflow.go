...
func (a *AirflowBalancer) WithinLimits(reading model.WicketReading) bool {
	o2 := reading.ExcessO2Pct
	return o2 >= model.MinHublockO2Percent && o2 <= model.MaxHublockO2Percent
}
